!function (e) {
    ...
    var n = function (n, a) {
        var r, i, o, s, d, l, p, c = {}, u = !0, f = !1, m = !1, h = 0, g = [{
            clsName: "days",
            navFnc: "M",
            navStep: 1
            ...
            navFnc: "y",
            navStep: 100
        }], y = ["days", "months", "years", "decades"], b = ["top", "bottom", "auto"], w = ["left", "right", "auto"], v = ["default", "top", "bottom"], k = {
            up: 38,
            38: "up",
            down: 40,
            40: "down",
            ...
            var n, r, i, o, s, d = !1;
            return void 0 !== t.tz && void 0 !== a.timeZone && null !== a.timeZone && "" !== a.timeZone && (d = !0), void 0 === e || null === e ? n = d ? t().tz(a.timeZone).startOf("d") : t().startOf("d") : d ? (r = t().tz(a.timeZone).utcOffset(), i = t(e, l, a.useStrict).utcOffset(), i !== r ? (o = t().tz(a.timeZone).format("Z"), s = t(e, l, a.useStrict).format("YYYY-MM-DD[T]HH:mm:ss") + o, n = t(s, l, a.useStrict).tz(a.timeZone)) : n = t(e, l, a.useStrict).tz(a.timeZone)) : n = t(e, l, a.useStrict), n
        }, D = function (e) {
            ...
            }).addClass("btn").attr("data-action", "decrementHours").append(e("<span>").addClass(a.icons.down))))), D("m") && (D("h") && (t.append(e("<td>").addClass("separator")), n.append(e("<td>").addClass("separator").html(":")), r.append(e("<td>").addClass("separator"))), t.append(e("<td>").append(e("<a>").attr({
                href: "#",
                tabindex: "-1",
            ...
            }).addClass("btn").attr("data-action", "decrementMinutes").append(e("<span>").addClass(a.icons.down))))), D("s") && (D("m") && (t.append(e("<td>").addClass("separator")), n.append(e("<td>").addClass("separator").html(":")), r.append(e("<td>").addClass("separator"))), t.append(e("<td>").append(e("<a>").attr({
                href: "#",
                tabindex: "-1",
            ...
            var t = e("<div>").addClass("timepicker-hours").append(e("<table>").addClass("table-condensed")), n = e("<div>").addClass("timepicker-minutes").append(e("<table>").addClass("table-condensed")), a = e("<div>").addClass("timepicker-seconds").append(e("<table>").addClass("table-condensed")), r = [O()];
            return D("h") && r.push(t), D("m") && r.push(n), D("s") && r.push(a), r
        }, E = function () {
            var t = [];
            return a.showTodayButton && t.push(e("<td>").append(e("<a>").attr({
                "data-action": "today",
                title: a.tooltips.today
           /* }).append(e("<span>").addClass(a.icons.today)))), !a.sideBySide && M() && T() && t.push(e("<td>").append(e("<a>").attr({
            ...
            var t = e("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"), n = e("<div>").addClass("datepicker").append(S()), r = e("<div>").addClass("timepicker").append(P()), i = e("<ul>").addClass("list-unstyled"), o = e("<li>").addClass("picker-switch" + (a.collapse ? " accordion-toggle" : "")).append(E());
            ...
            var t, r = {};
            return t = n.is("input") || a.inline ? n.data() : n.find("input").data(), t.dateOptions && t.dateOptions instanceof Object && (r = e.extend(!0, r, t.dateOptions)), e.each(a, function (e) {
            ...
            if ("auto" === o && (o = i.top + 1.5 * m.height() >= e(window).height() + e(window).scrollTop() && m.height() + n.outerHeight() < i.top ? "top" : "bottom"), "auto" === s && (s = t.width() < i.left + m.outerWidth() / 2 && i.left + m.outerWidth() > e(window).width() ? "right" : "left"), "top" === o ? m.addClass("top").removeClass("bottom") : m.addClass("bottom").removeClass("top"), "right" === s ? m.addClass("pull-right") : m.removeClass("pull-right"), "relative" !== t.css("position") && (t = t.parents().filter(function () {
            ...
            m.css({
                ...
                bottom: "top" === o ? r.top + n.outerHeight() : "auto",
            ...
            m && (e && (p = Math.max(h, Math.min(3, p + e))), m.find(".datepicker > div").hide().filter(".datepicker-" + g[p].clsName).show())
        }, z = function () {
            var t = e("<tr>"), n = i.clone().startOf("w").startOf("d");
            for (a.calendarWeeks === !0 && t.append(e("<th>").addClass("cw").text("#")); n.isBefore(i.clone().endOf("w"));)t.append(e("<th>").addClass("dow").text(n.format("dd"))), n.add(1, "d");
            m.find(".datepicker-days thead").append(t)
        }, F = function (e) {
            return a.disabledDates[e.format("YYYY-MM-DD")] === !0
        }, L = function (e) {
            return a.enabledDates[e.format("YYYY-MM-DD")] === !0
        }, W = function (e) {
            return a.disabledHours[e.format("H")] === !0
        }, A = function (e) {
            return a.enabledHours[e.format("H")] === !0
        }, N = function (t, n) {
            ...
            if (a.enabledHours && ("h" === n || "m" === n || "s" === n) && !A(t))return !1;
            ...
            var e = m.find(".datepicker-years"), t = e.find("th"), n = i.clone().subtract(5, "y"), o = i.clone().add(6, "y"), s = "";
            ...
            var e = m.find(".datepicker-decades"), n = e.find("th"), o = t({y: i.year() - i.year() % 100 - 1}), s = o.clone().add(100, "y"), d = o.clone(), l = "";
            for (n.eq(0).find("span").attr("title", a.tooltips.prevCentury), n.eq(2).find("span").attr("title", a.tooltips.nextCentury), e.find(".disabled").removeClass("disabled"), (o.isSame(t({y: 1900})) || a.minDate && a.minDate.isAfter(o, "y")) && n.eq(0).addClass("disabled"), n.eq(1).text(o.year() + "-" + s.year()), (o.isSame(t({y: 2e3})) || a.maxDate && a.maxDate.isBefore(s, "y")) && n.eq(2).addClass("disabled"); !o.isAfter(s, "y");)l += '<span data-action="selectDecade" class="decade' + (o.isSame(r, "y") ? " active" : "") + (N(o, "y") ? "" : " disabled") + '" data-selection="' + (o.year() + 6) + '">' + (o.year() + 1) + " - " + (o.year() + 12) + "</span>", o.add(12, "y");
            l += "<span></span><span></span><span></span>", e.find("td").html(l), n.eq(1).text(d.year() + 1 + "-" + o.year())
        }, Q = function () {
            var t, n, o, s, d = m.find(".datepicker-days"), l = d.find("th"), p = [];
            if (M()) {
                for (l.eq(0).find("span").attr("title", a.tooltips.prevMonth), l.eq(1).attr("title", a.tooltips.selectMonth), l.eq(2).find("span").attr("title", a.tooltips.nextMonth), d.find(".disabled").removeClass("disabled"), l.eq(1).text(i.format(a.dayViewHeaderFormat)), N(i.clone().subtract(1, "M"), "M") || l.eq(0).addClass("disabled"), N(i.clone().add(1, "M"), "M") || l.eq(2).addClass("disabled"), t = i.clone().startOf("M").startOf("w").startOf("d"), s = 0; 42 > s; s++)0 === t.weekday() && (n = e("<tr>"), a.calendarWeeks && n.append('<td class="cw">' + t.week() + "</td>"), p.push(n)), o = "", t.isBefore(i, "M") && (o += " old"), t.isAfter(i, "M") && (o += " new"), t.isSame(r, "d") && !u && (o += " active"), N(t, "d") || (o += " disabled"), t.isSame(x(), "d") && (o += " today"), (0 === t.day() || 6 === t.day()) && (o += " weekend"), n.append('<td data-action="selectDay" data-day="' + t.format("L") + '" class="day' + o + '">' + t.date() + "</td>"), t.add(1, "d");
                d.find("tbody").empty().append(p), V(), R(), U()
            }
        }, G = function () {
            ...
            var t = u ? null : r;
            return e ? (e = e.clone().locale(a.locale), 1 !== a.stepping && e.minutes(Math.round(e.minutes() / a.stepping) * a.stepping % 60).seconds(0), void(N(e) ? (r = e, i = r.clone(), o.val(r.format(d)), n.data("date", r.format(d)), u = !1, $(), q({
                type: "dp.change",
                date: r.clone(),
                oldDate: t
            })) : (a.keepInvalid || o.val(u ? "" : r.format(d)), q({
                type: "dp.error",
                date: e
            })))) : (u = !0, o.val(""), n.data("date", ""), q({type: "dp.change", date: !1, oldDate: t}), void $())
        }, ee = function () {
            var t = !1;
            ...
            next: function () {
                var e = g[p].navFnc;
                i.add(g[p].navStep, e), Q(), B(e)
            }, previous: function () {
                var e = g[p].navFnc;
                i.subtract(g[p].navStep, e), Q(), B(e)
            }, pickerSwitch: function () {
                j(1)
            }, selectMonth: function (t) {
                var n = e(t.target).closest("tbody").find("span").index(e(t.target));
                i.month(n), p === h ? (_(r.clone().year(i.year()).month(i.month())), a.inline || ee()) : (j(-1), Q()), B("M")
            }, selectYear: function (t) {
                var n = parseInt(e(t.target).text(), 10) || 0;
                i.year(n), p === h ? (_(r.clone().year(i.year())), a.inline || ee()) : (j(-1), Q()), B("YYYY")
            }, selectDecade: function (t) {
                var n = parseInt(e(t.target).data("selection"), 10) || 0;
                i.year(n), p === h ? (_(r.clone().year(i.year())), a.inline || ee()) : (j(-1), Q()), B("YYYY")
            }, selectDay: function (t) {
                var n = i.clone();
                e(t.target).is(".old") && n.subtract(1, "M"), e(t.target).is(".new") && n.add(1, "M"), _(n.date(parseInt(e(t.target).text(), 10))), T() || a.keepOpen || a.inline || ee()
                ...
                var n, r = e(t.target), i = r.closest("ul"), o = i.find(".in"), s = i.find(".collapse:not(.in)");
                if (o && o.length) {
                    if (n = o.data("collapse"), n && n.transitioning)return;
                    o.collapse ? (o.collapse("hide"), s.collapse("show")) : (o.removeClass("in"), s.addClass("in")), r.is("span") ? r.toggleClass(a.icons.time + " " + a.icons.date) : r.find("span").toggleClass(a.icons.time + " " + a.icons.date)
                }
            }, showPicker: function () {
                ...
                s || (r.hours() >= 12 ? 12 !== n && (n += 12) : 12 === n && (n = 0)), _(r.clone().hours(n)), ne.showPicker.call(c)
            ...
            return o.prop("disabled") || !a.ignoreReadonly && o.prop("readonly") || m ? c : (void 0 !== o.val() && 0 !== o.val().trim().length ? _(oe(o.val().trim())) : a.useCurrent && u && (o.is("input") && 0 === o.val().trim().length || a.inline) && (t = x(), "string" == typeof a.useCurrent && (t = n[a.useCurrent](t)), _(t)), m = H(), z(), Z(), m.find(".timepicker-hours").hide(), m.find(".timepicker-minutes").hide(), m.find(".timepicker-seconds").hide(), $(), j(), e(window).on("resize", Y), m.on("click", "[data-action]", ae), m.on("mousedown", !1), f && f.hasClass("btn") && f.toggleClass("active"), m.show(), Y(), a.focusOnShow && !o.is(":focus") && o.focus(), q({type: "dp.show"}), c)
        }, ie = function () {
            return m ? ee() : re()
        }, oe = function (e) {
            return e = void 0 === a.parseInputDate ? t.isMoment(e) || e instanceof Date ? t(e) : x(e) : a.parseInputDate(e), e.locale(a.locale), e
        }, se = function (e) {
            var t, n, r, i, o = null, s = [], d = {}, l = e.which, p = "p";
            C[l] = p;
            for (t in C)C.hasOwnProperty(t) && C[t] === p && (s.push(t), parseInt(t, 10) !== l && (d[t] = !0));
            for (t in a.keyBinds)if (a.keyBinds.hasOwnProperty(t) && "function" == typeof a.keyBinds[t] && (r = t.split(" "), r.length === s.length && k[l] === r[r.length - 1])) {
            ...
            var n = e(t.target).val().trim(), a = n ? oe(n) : null;
            ...
            o.on({
                ...
                keydown: se,
                keyup: de,
                focus: a.allowInputToggle ? re : ""
            }), n.is("input") ? o.on({focus: re}) : f && (f.on("click", ie), f.on("mousedown", !1))
        }, ce = function () {
            o.off({
                change: le,
                blur: blur,
            ...
            }), n.is("input") ? o.off({focus: re}) : f && (f.off("click", ie), f.off("mousedown", !1))
        }, ue = function (t) {
            var n = {};
            ...
            }), l = a.extraFormats ? a.extraFormats.slice() : [], l.indexOf(e) < 0 && l.indexOf(d) < 0 && l.push(d), s = d.toLowerCase().indexOf("a") < 1 && d.replace(/\[.*?\]/g, "").indexOf("h") < 1, D("y") && (h = 2), D("M") && (h = 1), D("d") && (h = 0), p = Math.max(h, p), u || _(r)
        };
        if (c.destroy = function () {
                ee(), ce(), n.removeData("DateTimePicker"), n.removeData("date")
            }, c.toggle = ie, c.show = re, c.hide = ee, c.disable = function () {
                ...
                return a.format = e, d && me(), c
            }, c.timeZone = function (e) {
                return 0 === arguments.length ? a.timeZone : (a.timeZone = e, c)
                ...
                return a.extraFormats = e, l && me(), c
                ...
                return a.disabledDates = ue(t), a.enabledDates = !1, $(), c
                ...
                return a.enabledDates = ue(t), a.disabledDates = !1, $(), c
                ...
                if ("boolean" == typeof e && e === !1)return a.maxDate = !1, $(), c;
                ...
                if ("boolean" == typeof e && e === !1)return a.minDate = !1, $(), c;
                "string" == typeof e && ("now" === e || "moment" === e) && (e = x());
                var t = oe(e);
                ...
                return a.locale = e, r.locale(a.locale), i.locale(a.locale), d && me(), m && (ee(), re()), c
            }, c.stepping = function (e) {
                return 0 === arguments.length ? a.stepping : (e = parseInt(e, 10), (isNaN(e) || 1 > e) && (e = 1), a.stepping = e, c)
                ...
                return a.sideBySide = e, m && (ee(), re()), c
                ...
                if (a.disabledHours = fe(t), a.enabledHours = !1, a.useCurrent && !a.keepInvalid) {
                    for (var n = 0; !N(r, "h");) {
                ...
                if (a.enabledHours = fe(t), a.disabledHours = !1, a.useCurrent && !a.keepInvalid) {
                    for (var n = 0; !N(r, "h");) {
                        if (r.add(1, "h"), 24 === n)throw"Tried 24 times to find a valid date";
                        n++
                    }
                ...
                return i = oe(e), B(), c
            }, n.is("input"))o = n; else if (o = n.find(a.datepickerInput), 0 === o.size())o = n.find("input"); else if (!o.is("input"))throw new Error('CSS class "' + a.datepickerInput + '" cannot be applied to non input element');
        if (n.hasClass("input-group") && (f = n.find(0 === n.find(".datepickerbutton").size() ? ".input-group-addon" : ".datepickerbutton")), !a.inline && !o.is("input"))throw new Error("Could not initialize DateTimePicker without an input element");
        return r = x(), i = r.clone(), e.extend(!0, a, I()), c.options(a), me(), pe(), o.prop("disabled") && c.disable(), o.is("input") && 0 !== o.val().trim().length ? _(oe(o.val().trim())) : a.defaultDate && void 0 === o.attr("placeholder") && _(a.defaultDate), a.inline && re(), c
    };
    e.fn.datetimepicker = function (t) {
        return this.each(function () {
            var a = e(this);
            a.data("DateTimePicker") || (t = e.extend(!0, {}, e.fn.datetimepicker.defaults, t), a.data("DateTimePicker", n(a, t)))
        })
