...
!function (e, t, o, n) {
    ...
    o(function () {
        o('[data-toggle="popover"]').popover(), o('[data-toggle="tooltip"]').tooltip({container: "body"}), o(".dropdown input").on("click focus", function (e) {
            e.stopPropagation()
        })
    })
}(window, document, window.jQuery), function (e, t, o, n) {
    function a(e, t) {
        ...
        e.fullCalendar({
            ...
            droppable: !0,
            drop: function (t, a) {
                var r = o(this), i = r.data("calendarEventObject");
                if (i) {
                    var l = o.extend({}, i);
    ...
    function r(e) {
        ...
        var n = "#f6504d", a = o(".external-event-add-btn"), r = o(".external-event-name"), i = o(".external-event-color-selector .circle");
        o(".external-events-trash").droppable({
            ...
            var a = r.val();
            if ("" !== o.trim(a)) {
                var i = o("<div/>").css({"background-color": n, "border-color": n, color: "#fff"}).html(a);
    ...
    function i() {
        var e = new Date, t = e.getDate(), o = e.getMonth(), n = e.getFullYear();
        return [{
            title: "All Day Event",
    ...
    if (o.fn.fullCalendar) {
        o(function () {
            var e = o("#calendar"), t = i();
            r(e), a(e, t)
        });
        var l = null, s = function (e) {
            e && e.each(function () {
                var e = o(this), t = {title: o.trim(e.text())};
    ...
    o(function () {
        if ("undefined" != typeof Chart) {
            var e = function () {
                ...
                datasetFill: !0,
                responsive: !0
            }, a = t.getElementById("chartjs-linechart").getContext("2d"), r = (new Chart(a).Line(o, n), {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
                    fillColor: "#23b7e5",
                    strokeColor: "#23b7e5",
                ...
                barDatasetSpacing: 1,
                responsive: !0
            }, l = t.getElementById("chartjs-barchart").getContext("2d"), s = (new Chart(l).Bar(r, i), [{
                value: 300,
                color: "#7266ba",
                highlight: "#7266ba",
                label: "Purple"
            }, {value: 50, color: "#23b7e5", highlight: "#23b7e5", label: "Info"}, {
                value: 100,
                color: "#fad732",
                highlight: "#fad732",
                label: "Yellow"
                ...
                animateScale: !1,
                responsive: !0
            }, d = t.getElementById("chartjs-doughnutchart").getContext("2d"), u = (new Chart(d).Doughnut(s, c), [{
                value: 300,
                color: "#7266ba",
                highlight: "#7266ba",
                label: "Purple"
            }, {value: 40, color: "#fad732", highlight: "#fad732", label: "Yellow"}, {
                value: 120,
                color: "#23b7e5",
                highlight: "#23b7e5",
                label: "Info"
                ...
                animateScale: !1,
                responsive: !0
            }, p = t.getElementById("chartjs-piechart").getContext("2d"), h = (new Chart(p).Pie(u, f), [{
                value: 300,
                color: "#f532e5",
                highlight: "#f532e5",
                label: "Red"
            }, {value: 50, color: "#7266ba", highlight: "#7266ba", label: "Green"}, {
                value: 100,
                color: "#f532e5",
                highlight: "#f532e5",
                label: "Yellow"
            }, {value: 140, color: "#7266ba", highlight: "#7266ba", label: "Grey"}]), g = {
                ...
                animateScale: !1,
                responsive: !0
            }, m = t.getElementById("chartjs-polarchart").getContext("2d"), y = (new Chart(m).PolarArea(h, g), {
    ...
    o(function () {
        if ("undefined" != typeof Chartist) {
            var t = {
                ...
                high: 10, low: -10, height: 280, axisX: {
            ...
            }, {low: 0, height: 300}), r = 0, i = 80, l = 500;
            a.on("created", function () {
                ...
                if (r++, "line" === e.type)e.element.animate({
                    ...
                    x2: {begin: r * i, dur: l, from: e.x - 10, to: e.x, easing: "easeOutQuart"},
                    opacity: {begin: r * i, dur: l, from: 0, to: 1, easing: "easeOutQuart"}
                }); else if ("grid" === e.type) {
                    var t = {
                        begin: r * i,
                        dur: l,
    ...
    o(function () {
        ...
        function n(e, t) {
            var n = -20;
            !e.hasClass(i) && o.Utils.isInView(e, {topoffset: n}) && a(e, t)
        }
    ...
    "undefined" != typeof screenfull && o(function () {
        ...
        var a = o(t), r = o("[data-toggle-fullscreen]"), i = e.navigator.userAgent;
    ...
    "use strict";
    var n = [{featureType: "water", stylers: [{visibility: "on"}, {color: "#bdd1f9"}]}, {
        featureType: "all",
    ...
    }, {featureType: "road", stylers: [{color: "#d8dbe0", lightness: 20}]}], a = "[data-gmap]";
    if (e.fn.gMap) {
        var r = [];
        e(a).each(function () {
            var t = e(this), o = t.data("address") && t.data("address").split(";"), a = t.data("title") && t.data("title").split(";"), i = t.data("zoom") || 14, l = t.data("maptype") || "ROADMAP", s = [];
            if (o) {
                for (var c in o)"string" == typeof o[c] && s.push({address: o[c], html: a && a[c] || "", popup: !0});
                var d = {
                    controls: {
                        panControl: !0,
                        zoomControl: !0,
                    ...
                    }, scrollwheel: !1, maptype: l, markers: s, zoom: i
                }, u = t.gMap(d), f = u.data("gMap.reference");
                r.push(f), void 0 !== t.data("styled") && f.setOptions({styles: n})
            }
        })
    }
}(jQuery, window, document), function (e, t, o, n) {
    o(function () {
        if (o.fn.cropper) {
            var n = o(".img-container > img"), a = o("#dataX"), r = o("#dataY"), i = o("#dataHeight"), l = o("#dataWidth"), s = o("#dataRotate"), c = {
                aspectRatio: 16 / 9,
                preview: ".img-preview",
                crop: function (e) {
            ...
            var d, u = o("#inputImage"), f = e.URL || e.webkitURL;
            f ? u.change(function () {
                var e, t = this.files;
    ...
    var a = "en", r = "i18n", i = "site", l = "jq-appLang";
    o(function () {
        function e(e) {
        ...
        if (o.fn.localize) {
            var n = o.localStorage.get(l) || a, s = {
                language: n, pathPrefix: r, callback: function (e, t) {
                    o.localStorage.set(l, n), t(e)
                }
            };
            e(s), o("[data-set-lang]").on("click", function () {
                n = o(this).data("setLang"), n && (s.language = n, e(s), t(o(this)))
            })
        }
    })
}(window, document, window.jQuery), function (e, t, o, n) {
            ...
            e.vectorMap({
                ...
                regionStyle: {
                    initial: {
                        ...
                        "stroke-width": 1.5,
                        "stroke-opacity": 1
                    }, hover: {"fill-opacity": .8}, selected: {fill: "blue"}, selectedHover: {}
                },
                focusOn: {x: .4, y: .6, scale: t.scale},
                ...
                markers: n,
                series: {regions: [{values: o, scale: t.scaleColors, normalizeFunction: "polynomial"}]}
            })
        }

        if (e && e.length) {
            var a = e.data(), r = a.height || "300", i = {
    ...
    o(function () {
        if ("undefined" != typeof Morris) {
            var e = [{y: "2006", a: 100, b: 90}, {y: "2007", a: 75, b: 65}, {y: "2008", a: 50, b: 40}, {
                y: "2009",
                a: 75,
                b: 65
                ...
                a: 100,
                b: 90
            }], t = [{label: "Download Sales", value: 12}, {
    ...
    o(function () {
        ...
        var r = o("[data-search-dismiss]"), i = '.navbar-form input[type="text"]';
    ...
    var n = {}, a = {}, r = function (t) {
        return "string" == e.type(t) && (t = {message: t}), arguments[1] && (t = e.extend(t, "string" == e.type(arguments[1]) ? {status: arguments[1]} : arguments[1])), new l(t).show()
    }, i = function (e, t) {
        if (e)for (var o in a)e === a[o].group && a[o].close(t); else for (var o in a)a[o].close(t)
    }, l = function (t) {
    ...
    "use strict";
    var n = '[data-tool="panel-dismiss"]', a = "panel.remove", r = "panel.removed";
    e(o).on("click", n, function () {
        function t() {
            e.support.animation ? n.animo({animation: "bounceOut"}, o) : o()
        }
        ...
        var n = e(this).closest(".panel"), i = new e.Deferred;
    ...
    e(l).each(function () {
        var t = e(this), o = t.closest(".panel"), l = o.find(".panel-wrapper"), s = {toggle: !1}, c = t.children("em"), d = o.attr("id");
    ...
    var a = '[data-tool="panel-refresh"]', r = "panel.refresh", i = "whirl", l = "standard";
    e(o).on("click", a, function () {
        var t = e(this), o = t.parents(".panel").eq(0), a = t.data("spinner") || l;
    ...
    e(function () {
        ...
        e(n).each(function () {
            ...
            var o = e(this), n = o.data("offset"), r = o.data("delay") || 100, i = o.data("play") || "bounce";
            "undefined" != typeof n && (t(o), a.scroll(function () {
                t(o)
            }))
        }), e(o).on("click", n, function () {
            var t = e(this), o = t.data("target"), n = t.data("play") || "bounce", a = e(o);
            a && a.length && a.animo({animation: n})
        })
    })
}(jQuery, window, document), function (e, t, o) {
    "use strict";
    ...
    if (e.fn.sortable) {
        var r = '[data-toggle="portlet"]', i = "jq-portletState";
        e(function () {
            e(r).sortable({
                connectWith: r,
                items: "div.panel",
    ...
    o(function () {
        if ("undefined" != typeof Rickshaw) {
            ...
            var a = [{color: "#c05020", data: e[0], name: "New York"}, {
                ...
                data: e[2],
                name: "Tokyo"
            }], r = new Rickshaw.Graph({element: t.querySelector("#rickshaw1"), series: a, renderer: "area"});
            r.render();
    ...
    o(function () {
        o.fn.select2 && (o("#select2-1").select2({theme: "bootstrap"}), o("#select2-2").select2({theme: "bootstrap"}), o("#select2-3").select2({theme: "bootstrap"}), o("#select2-4").select2({
    ...
    function i(e) {
        ...
        var n = o(".aside"), a = o(".aside-inner"), i = parseInt(a.css("padding-top"), 0) + parseInt(n.css("padding-top"), 0), s = t.clone().appendTo(n);
        r(e);
        var c = e.position().top + i - g.scrollTop(), u = f.height();
    ...
    o(function () {
        o("[data-skycon]").each(function () {
            var e = o(this), t = new Skycons({color: e.data("color") || "white"});
    ...
    o(function () {
        o("[data-scrollable]").each(function () {
            var e = o(this), t = 250;
            e.slimScroll({height: e.data("height") || t})
        })
    })
}(window, document, window.jQuery), function (e, t, o, n) {
    o(function () {
        function t() {
            var t = o(this), n = t.data(), a = n.values && n.values.split(",");
    ...
    o(function () {
        o("[data-check-all]").on("change", function () {
            var e = o(this), t = e.index() + 1, n = e.find('input[type="checkbox"]'), a = e.parents("table");
    ...
    o(function () {
        ...
        toggle = new StateToggler, o("[data-toggle-state]").on("click", function (a) {
            a.stopPropagation();
            var r = o(this), i = r.data("toggleState"), l = r.data("target"), s = r.attr("data-no-persist") !== n, c = l ? o(l) : t;
    ...
    o(function () {
        var n = o("[data-trigger-resize]"), a = n.data("triggerResize");
        n.on("click", function () {
            setTimeout(function () {
    ...
    e.support.transition = function () {
        ...
        e && setTimeout(function () {
            try {
                for (d = document.styleSheets, a = 0, l = d.length; l > a; a++) {
                    for (n = d[a], o = [], n.cssRules = n.cssRules, t = r = 0, s = n.cssRules.length; s > r; t = ++r)n.cssRules[t].type === CSSRule.STYLE_RULE && e.test(n.cssRules[t].selectorText) && o.unshift(t);
                    for (i = 0, c = o.length; c > i; i++)n.deleteRule(o[i])
                }
            } catch (u) {
            }
        }, 0)
        ...
        var r = a.scrollLeft(), i = a.scrollTop(), l = n.offset(), s = l.left, c = l.top;
        return o = e.extend({
            topoffset: 0,
            leftoffset: 0
        }, o), c + n.height() >= i && c - o.topoffset <= i + a.height() && s + n.width() >= r && s - o.leftoffset <= r + a.width() ? !0 : !1
