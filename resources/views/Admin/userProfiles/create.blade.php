                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <label class="radio-inline c-radio">
                                    <input id="inlineradio1" type="radio" name="sex" value="female" {{ old('sex') === "female" ? 'checked': '' }}>
                                    <span class="fa fa-circle"></span>Femenino</label>
                                <label class="radio-inline c-radio">
                                    <input id="inlineradio2" type="radio" name="sex" value="male" {{ old('sex') === "male" ? 'checked': '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" value="{{ old('address') }}" class="form-control"
                                   placeholder="calle 24 Rangel sector Las Heroínas">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="emergency_name" value="{{ old('emergency_name') }}"
                                   class="form-control" placeholder="Persona Cercana">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Teléfono</label>
                            <input type="text" name="emergency_phone" value="{{ old('emergency_phone') }}"
                                   class="form-control" placeholder="(0414)-1234567 (0274)-2134567">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Dirección</label>
                            <input type="text" name="emergency_address" value="{{ old('emergency_phone') }}"
                                   class="form-control" placeholder="calle 24 Rangel sector Las Heroínas">
                        </div>
