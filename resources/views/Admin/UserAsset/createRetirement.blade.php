...
@section('content')
    @include('template.Partials.ValidateError')
        ...
        <div class="content-wrapper">
            <h3>Retiro Haberes
                <small>del Asociado </small>
            </h3>
            <div class="row">
                <div class="col-md-12">
                    {!! Form::open( array( 'route' => 'Admin.UserAsset.storeRetirement') ) !!}
                            <!-- START panel-->
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Seleccione Retiro</label>
                                <select name="reason" class="form-control">
                                    <option value=" " > </option>
                                    <option value="partial" {{ old('reason') === "partial" ? 'selected': '' }} >Parcial</option>
                                    <option value="total" {{ old('reason') === "deposit" ? 'selected': '' }}>Total</option>
                                </select>
                            </div>
                            <div class="form-group">
