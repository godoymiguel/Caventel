                ...
                <div class="rev-slider-banner-full  rev-slider-full">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <img src="{{ asset('images/estacion-barnitas-101.jpg')}}" alt="rev-full1"
                        ...
                        <div class="col-md-3 col-sm-3">
                            ...
                            >
                                ...
                                <div class="content-box-text">
                                    ...
                                    <div>
                                        <a href="{{ asset('pdf/ESTATUTOSCAVENTEL2014.pdf') }}"
                                           onclick="window.open(this.href); return false;" class=" btn btn-sm">
                                            <span>Descargar</span>
                                        </a>
                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="message-box clearfix">
                                ...
                                <div class="message-content">
                                    <h4>¿Deseas ser Asociado de Caventel? Conoces los Requisitos Para formar Parte de
                                        Nosotros</h4>
                                </div>
                    ...
                    <div class="tab-container">
                        ...
                        <div class="section-etabs-container">
                            <ul class="section-etabs">
                                ...
                                <li class="tab">
                                    <a href="{{ route('user.news') }}"> Más Noticias </a>
                                </li>
                                            ...
                                            <div class="col-md-3 col-sm-3 ">
                                                <div class="feature animated"
                                                    ...
                                                    <div class="img-overlay">
                                                        <img src="{{ asset('img/news/' . $item->img) }}" height="150" alt="webpage">
                                                    </div>
                        ...
                        <ul class="icon-content-list-container">
                            ...
                            <li class="icon-content-single">
                                ...
                                >
                                    <h4 class="h4-body-title">
                                        <strong>
                                            <a href="{{ url('http://www.mintur.gob.ve/mintur/ventel/teleferico-de-merida-mukumbari/') }}"
                                               target="_blank">
                                                MUKUMBARÍ
                                            </a>
                                        </strong>
